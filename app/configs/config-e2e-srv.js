  ...
  var config = {
    ...
    server_connect: true,     // server logs, records stream & iactive cameras 
    server_host: 'localhost',
    http_port: 8080,
    channels_port: 8081,
    channels_in: ['actions'],
    channels_out: ['log', 'actions'],
    record_stream: true,   // re-record action sequence
    record_shots: true,   // record (overdub) interactive camera shots
    log: true,           // log action, abs_url, delta_url and scope.shot
